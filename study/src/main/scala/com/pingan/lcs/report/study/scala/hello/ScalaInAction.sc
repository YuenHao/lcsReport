package com.pingan.lcs.report.study.scala.hello
/**
 * Author: 	Wang Jialin
 * Contact Information:
 * 	WeChat:	18610086859
...
object ScalaInAction {
  println("Welcome to the Scala worksheet")       //> Welcome to the Scala worksheet
   ...
   val s = Array("Hello", "World")                //> s  : Array[String] = Array(Hello, World)
    ...
    b += 1                                        //> res1: com.pingan.lcs.report.study.scala.hello.ScalaInAction.b.type = ArrayBuffer(1)
    b += (1, 2, 3, 5)                             //> res2: com.pingan.lcs.report.study.scala.hello.ScalaInAction.b.type = ArrayBuffer(1, 1, 2, 3, 5)
    b ++= Array(8, 13, 21)                        //> res3: com.pingan.lcs.report.study.scala.hello.ScalaInAction.b.type = ArrayBuffer(1, 1, 2, 3, 5, 8
                                                  //| , 13, 21)
...
scores += ("R" -> 9)                              //> res23: com.pingan.lcs.report.study.scala.hello.ScalaInAction.scores.type = Map(Hadoop -> 8, R ->
                                                  //|  9, Spark -> 10, Scala -> 7)
  scores -= "Hadoop"                              //> res24: com.pingan.lcs.report.study.scala.hello.ScalaInAction.scores.type = Map(R -> 9, Spark ->
                                                  //| 10, Scala -> 7)
...
val regex="""([0-9]+) ([a-z]+)""".r               //> regex  : scala.util.matching.Regex = ([0-9]+) ([a-z]+)
    ...
    val regex(num, blog) = line                   //> scala.MatchError: 20150623 Spark (of class java.lang.String)
                                                  //| 	at com.pingan.lcs.report.study.scala.hello.ScalaInAction$$anonfun$main$1.apply$mcV$sp(com.dt.
                                                  ...
                                                  //| 	at com.pingan.lcs.report.study.scala.hello.ScalaInAction$.main(com.pingan.lcs.report.study.scala.hello.ScalaInActi
                                                  //| on.scala:10)
                                                  //| 	at com.pingan.lcs.report.study.scala.hello.ScalaInAction.main(com.pingan.lcs.report.study.scala.hello.ScalaInActio
                                                  //| n.scala)
